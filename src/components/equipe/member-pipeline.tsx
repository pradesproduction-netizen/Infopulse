...
const COLUMNS: {
  ...
  { stage: 'rdv_booke', label: 'RDV booké', borderColor: 'border-violet-500/30', headerClass: 'bg-violet-500/10 text-violet-300', badgeClass: 'bg-violet-500/10 text-violet-300 border-violet-500/30' },
  { stage: 'no_show', label: 'No show', borderColor: 'border-orange-500/30', headerClass: 'bg-orange-500/10 text-orange-300', badgeClass: 'bg-orange-500/10 text-orange-300 border-orange-500/30' },
  { stage: 'proposition_envoyee', label: 'Proposition envoyée', borderColor: 'border-yellow-500/30', headerClass: 'bg-yellow-500/10 text-yellow-300', badgeClass: 'bg-yellow-500/10 text-yellow-300 border-yellow-500/30' },
  ...
  { stage: 'gagne', label: 'Gagné', borderColor: 'border-green-500/30', headerClass: 'bg-green-500/10 text-green-300', badgeClass: 'bg-green-500/10 text-green-300 border-green-500/30' },
      ...
      <div className="overflow-x-auto pb-4">
        <div className="flex gap-4 min-w-max">
          {COLUMNS.map((col) => {
            ...
            return (
              <div key={col.stage} className={cn('w-52 flex-shrink-0 rounded-xl border bg-card/30 flex flex-col', col.borderColor)}>
